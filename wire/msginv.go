...
// MsgInv implements the Message interface and represents a litecoin inv message.
...
// NewMsgInv returns a new litecoin inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new litecoin inv message that conforms to the
