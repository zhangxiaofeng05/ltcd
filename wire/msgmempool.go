...
// MsgMemPool implements the Message interface and represents a litecoin mempool
...
// NewMsgMemPool returns a new litecoin pong message that conforms to the Message
