...
// MsgGetData implements the Message interface and represents a litecoin
...
// NewMsgGetData returns a new litecoin getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new litecoin getdata message that conforms to
