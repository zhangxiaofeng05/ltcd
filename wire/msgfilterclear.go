...
// MsgFilterClear implements the Message interface and represents a litecoin
...
// NewMsgFilterClear returns a new litecoin filterclear message that conforms to the Message
