...
// MsgSendAddrV2 defines a litecoin sendaddrv2 message which is used for a peer
...
// NewMsgSendAddrV2 returns a new litecoin sendaddrv2 message that conforms to the
// Message interface.
