...
A complete description of the script language used by litecoin can be found at
...
litecoin transaction scripts.

# Script Overview

Litecoin transaction scripts are written in a stack-base, FORTH-like language.

The litecoin script language consists of a number of opcodes which fall into
...
The vast majority of Litecoin scripts at the time of this writing are of several
...
what conditions must be met in order to spend litecoins.
