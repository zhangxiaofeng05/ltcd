...
The litecoin block handling and chain selection rules are an integral, and quite
likely the most important, part of litecoin.  Unfortunately, at the time of
this writing, these rules are also largely undocumented and had to be
ascertained from the litecoind source code.  At its core, litecoin is a
...
Since this package does not deal with other litecoin specifics such as network
