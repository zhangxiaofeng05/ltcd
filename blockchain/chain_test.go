...
func TestHaveBlock(t *testing.T) {
	...
	tests := []struct {
		...
		// Block 1a should be present (on a side chain).
		{hash: "6baf42cfdd26ef32755103d4c52c8cfb1e33ba3f01fb96ae25fb911883266048", want: true},

		// Block 100000 should be present (as an orphan).
		{hash: "e11049dfa5858be3809f285685e12a5d6f84b936b0f8e8272b5363bf3946ce60", want: true},
