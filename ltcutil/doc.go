...
The Address interface provides an abstraction for a Litecoin address.  While the
most common type is a pay-to-pubkey-hash, Litecoin already supports others and
